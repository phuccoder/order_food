...
const _FoodDetail: FC<FoodDetailProps> = (props) => {
            ...
            <View style={styles.body}>
                ...
                <View style={{ height: 120 }}>
                        <FoodCard 
                            ...
                            onTap={() => {}} onUpdateCart={props.onUpdateCart}
                        />
                </View>
            </View>
        </View>
...
export const FoodDetailScreen = connect(mapToStateProps, { onUpdateCart })(_FoodDetail)